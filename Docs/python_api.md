...
## carla.FMCWLidarDetection<a name="carla.FMCWLidarDetection"></a>
Data contained inside a [carla.FMCWLidarMeasurement](#carla.FMCWLidarMeasurement). Each of these represents one of the points in the cloud with its location in spherical coordinates and its associated velocity and intensity.  

### Instance Variables
- <a name="carla.FMCWLidarDetection.azimuth"></a>**<font color="#f8805a">azimuth</font>** (_float<small> - degrees</small>_)  
Azimuth.  
- <a name="carla.FMCWLidarDetection.elevation"></a>**<font color="#f8805a">elevation</font>** (_float<small> - degrees</small>_)  
Elevation.  
- <a name="carla.FMCWLidarDetection.range"></a>**<font color="#f8805a">range</font>** (_float<small> - meters</small>_)  
Range.  
- <a name="carla.FMCWLidarDetection.intensity"></a>**<font color="#f8805a">intensity</font>** (_float_)  
Computed intensity for this point as a scalar value between [0.0 , 1.0].  
- <a name="carla.FMCWLidarDetection.velocity"></a>**<font color="#f8805a">velocity</font>** (_float<small> - meters per second</small>_)  
Computed velocity for this point as a scalar value in the radial direction toward the sensor.  
- <a name="carla.FMCWLidarDetection.valid"></a>**<font color="#f8805a">valid</font>** (_bool_)  
Flag indicating if this point is a blocking, non-dropped hit.  

### Methods

##### Dunder methods
- <a name="carla.FMCWLidarDetection.__str__"></a>**<font color="#7fb800">\__str__</font>**(<font color="#00a6ed">**self**</font>)  
...
## carla.FMCWLidarMeasurement<a name="carla.FMCWLidarMeasurement"></a>
<small style="display:block;margin-top:-20px;">Inherited from _[carla.SensorData](#carla.SensorData)_</small></br>
Class that defines the LIDAR data retrieved by a <b>sensor.lidar.fmcw</b>. This essentially simulates a rotating LIDAR using ray-casting with doppler velocity. Learn more about this [here](ref_sensors.md#FMCW-LIDAR-sensor).  

### Instance Variables
- <a name="carla.LidarMeasurement.channels"></a>**<font color="#f8805a">channels</font>** (_int_)  
Number of threads per laser.  
- <a name="carla.LidarMeasurement.beams"></a>**<font color="#f8805a">beams</font>** (_int_)  
Number of lasers shot.  
- <a name="carla.LidarMeasurement.horizontal_angle"></a>**<font color="#f8805a">horizontal_angle</font>** (_float<small> - radians</small>_)  
Horizontal angle the LIDAR is rotated at the time of the measurement.  
- <a name="carla.LidarMeasurement.raw_data"></a>**<font color="#f8805a">raw_data</font>** (_bytes_)  
...
##### Getters
- <a name="carla.LidarMeasurement.get_point_count_channel"></a>**<font color="#7fb800">get_point_count_channel</font>**(<font color="#00a6ed">**self**</font>)  
Retrieves the number of points that are generated by each channel.  
- <a name="carla.LidarMeasurement.get_point_count_beam"></a>**<font color="#7fb800">get_point_count_beam</font>**(<font color="#00a6ed">**self**</font>)  
Retrieves the number of points that are generated by each beam.  


##### Dunder methods
- <a name="carla.LidarMeasurement.__getitem__"></a>**<font color="#7fb800">\__getitem__</font>**(<font color="#00a6ed">**self**</font>, <font color="#00a6ed">**pos**=int</font>)  
- <a name="carla.LidarMeasurement.__iter__"></a>**<font color="#7fb800">\__iter__</font>**(<font color="#00a6ed">**self**</font>)  
Iterate over the [carla.FMCWLidarDetection](#carla.FMCWLidarDetection) retrieved as data.  
- <a name="carla.LidarMeasurement.__len__"></a>**<font color="#7fb800">\__len__</font>**(<font color="#00a6ed">**self**</font>)  
- <a name="carla.LidarMeasurement.__setitem__"></a>**<font color="#7fb800">\__setitem__</font>**(<font color="#00a6ed">**self**</font>, <font color="#00a6ed">**pos**=int</font>, <font color="#00a6ed">**detection**=[carla.FMCWLidarDetection](#carla.FMCWLidarDetection)</font>)  
- <a name="carla.LidarMeasurement.__str__"></a>**<font color="#7fb800">\__str__</font>**(<font color="#00a6ed">**self**</font>)  
