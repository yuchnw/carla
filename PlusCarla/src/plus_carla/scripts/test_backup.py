...
def wait_for_image(cam):
    try:
        img = cam.img_queue.get(timeout=2)
        cam.capture_image(img)
    except:
        print("Sensor '{}' did not return data in time".format(cam.sensor_name))

def handle_plus_vehicle_control(req):
    global vehicle, s_fc, s_fl, s_fr, s_lf, s_ls, s_lr, s_rf, s_rs, s_rr, lidar, left_aeva, right_aeva, radar_front_lr, radar_l_rear_sr, radar_r_rear_sr, display_manager, obs_vehicle_list
...
def run_simulation(args, client):
    ...
    global vehicle, s_fc, s_fl, s_fr, s_lf, s_ls, s_lr, s_rf, s_rf, s_rs, s_rr, lidar, left_aeva, right_aeva, radar_front_lr, radar_l_rear_sr, radar_r_rear_sr, display_manager, obs_vehicle_list
    ...
    try:
        ...
        s_fc = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=2.46, y=0, z=1.12), carla.Rotation(yaw=+00)), 
                             imu, {'fov': '121.2'}, display_pos=[0, 1])
        # seg_fc = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=2.46, y=0, z=1.12), carla.Rotation(yaw=+00)), 
        #                      imu, {'fov': '121.2'}, display_pos=None)
        # d_fc = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=2.46, y=0, z=1.12), carla.Rotation(yaw=+00)), 
        #                      imu, {'fov': '121.2'}, display_pos=None)
        ...
        # seg_fr = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=2.45, y=0.318, z=1.12), carla.Rotation(yaw=+00)), 
        #                      imu, {'fov': '47', 'role_name': 'front_right_camera'}, display_pos=None)
        # d_fr = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=2.45, y=0.318, z=1.12), carla.Rotation(yaw=+00)), 
        #                      imu, {'fov': '47', 'role_name': 'front_right_camera'}, display_pos=None)
        ...
        s_lf = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.077, y=-1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=-33)), 
                             imu, {'fov': '121.2', 'role_name': 'left_front_camera'}, display_pos=[1, 2])
        # seg_lf = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.077, y=-1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=-33)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_front_camera'}, display_pos=None)
        # d_lf = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.077, y=-1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=-33)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_front_camera'}, display_pos=None)
        ...
        s_ls = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.154, y=-1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=-93)), 
                             imu, {'fov': '121.2', 'role_name': 'left_side_camera'}, display_pos=[1, 1])
        # seg_ls = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.154, y=-1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=-93)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_side_camera'}, display_pos=None)
        # d_ls = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.154, y=-1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=-93)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_side_camera'}, display_pos=None)
        ...
        s_lr = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.232, y=-1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=-153)), 
                             imu, {'fov': '121.2', 'role_name': 'left_rear_camera'}, display_pos=[1, 0])
        # seg_lr = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.232, y=-1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=-153)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_rear_camera'}, display_pos=None)
        # d_lr = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.232, y=-1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=-153)), 
        #                      imu, {'fov': '121.2', 'role_name': 'left_rear_camera'}, display_pos=None)
        ...
        s_rf = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.077, y=1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=33)), 
                             imu, {'fov': '121.2', 'role_name': 'right_front_camera'}, display_pos=[2, 0])
        # seg_rf = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.077, y=1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=33)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_front_camera'}, display_pos=None)
        # d_rf = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.077, y=1.265, z=1.487), carla.Rotation(roll=-90, pitch=-10, yaw=33)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_front_camera'}, display_pos=None)
        ...
        s_rs = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.154, y=1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=93)), 
                             imu, {'fov': '121.2', 'role_name': 'right_side_camera'}, display_pos=[2, 1])
        # seg_rs = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.154, y=1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=93)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_side_camera'}, display_pos=None)
        # d_rs = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.154, y=1.293, z=1.487), carla.Rotation(roll=-90, pitch=-32, yaw=93)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_side_camera'}, display_pos=None)
        ...
        s_rr = SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=-0.232, y=1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=153)), 
                             imu, {'fov': '121.2', 'role_name': 'right_rear_camera'}, display_pos=[2, 2])
        # seg_rr = SensorManager(world, display_manager, 'SegCamera', carla.Transform(carla.Location(x=-0.232, y=1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=153)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_rear_camera'}, display_pos=None)
        # d_rr = SensorManager(world, display_manager, 'DepthCamera', carla.Transform(carla.Location(x=-0.232, y=1.283, z=1.487), carla.Rotation(roll=-90, pitch=-4, yaw=153)), 
        #                      imu, {'fov': '121.2', 'role_name': 'right_rear_camera'}, display_pos=None)
        
        # Lidars
        left_os0 = SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=0.722, y=-1.231, z=-0.145), carla.Rotation(roll=-35)), 
                      imu, {'channels' : '128', 'range' : '75', 'horizontal_fov': '360', 'upper_fov': '45', \
                            'lower_fov': '-45', 'points_per_second': '3300000'}, display_pos=None)

        right_os0 = SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=0.722, y=1.231, z=-0.145), carla.Rotation(roll=35)), 
                      imu, {'channels' : '128', 'range' : '75', 'horizontal_fov': '360', 'upper_fov': '45', \
                            'lower_fov': '-45', 'points_per_second': '3300000'}, display_pos=None)
        
        left_aeva = SensorManager(world, display_manager, 'FMCW', carla.Transform(carla.Location(x=2.48, y=-0.097, z=1.557), carla.Rotation(pitch=-3.2, yaw=-10)), 
                             imu, {'channels' : '64', 'range' : '500', 'role_name': 'left_aeva'}, display_pos=None)
        
        right_aeva = SensorManager(world, display_manager, 'FMCW', carla.Transform(carla.Location(x=2.48, y=0.097, z=1.557), carla.Rotation(pitch=-3.2, yaw=10)), 
                             imu, {'channels' : '64', 'range' : '500', 'role_name': 'right_aeva'}, display_pos=None)

        # left_os2 = SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=-0.128, y=-1.26, z=1.594), carla.Rotation(pitch=-5, yaw=45)), 
        #               imu, {'channels' : '128', 'range' : '350', 'horizontal_fov': '360', 'upper_fov': '11.25', \
        #                     'lower_fov': '-11.25', 'points_per_second': '2300000'}, display_pos=None)

        # right_os2 = SensorManager(world, display_manager, 'LiDAR', carla.Transform(carla.Location(x=-0.128, y=1.26, z=1.594), carla.Rotation(pitch=-5, yaw=-45)), 
        #               imu, {'channels' : '128', 'range' : '350', 'horizontal_fov': '360', 'upper_fov': '11.25', \
        #                     'lower_fov': '-11.25', 'points_per_second': '2300000'}, display_pos=None)
        
        # Radars - LR
        radar_front_lr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=4.408, y=-0.245, z=0.715), carla.Rotation(yaw=-25)), 
                             imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110', 'points_per_second': '10000', 'role_name': 'front_center_radar'}, display_pos=None)
        # radar_l_rear_lr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=0.018, y=-1.295, z=1.752), carla.Rotation(yaw=180)), 
        #                      imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)
        # radar_r_rear_lr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=0.018, y=1.295, z=1.752), carla.Rotation(yaw=180)), 
        #                      imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)
        # radar_l_corner_lr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=3.848, y=-1.185, z=-0.548), carla.Rotation(yaw=90)), 
        #                      imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)
        # radar_r_corner_lr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=3.848, y=1.185, z=-0.548), carla.Rotation(yaw=-90)), 
        #                      imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)

        # Radars - SR
        # radar_front_sr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=4.438, y=0.005, z=-0.733), carla.Rotation(yaw=25)), 
        #                      imu, {'range': '320', 'vertical_fov': '23', 'horizontal_fov': '110', 'points_per_second': '1000'}, display_pos=None)
        radar_l_rear_sr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=1.146, y=-1.296, z=-0.758), carla.Rotation(yaw=-125)), 
                             imu, {'range': '80', 'vertical_fov': '23', 'horizontal_fov': '110', 'points_per_second': '100000'}, display_pos=None)
        radar_r_rear_sr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=1.146, y=1.296, z=-0.758), carla.Rotation(yaw=125)), 
                             imu, {'range': '80', 'vertical_fov': '23', 'horizontal_fov': '110', 'points_per_second': '100000', 'role_name': 'rear_right_radar'}, display_pos=None)
        # radar_l_front_sr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=1.23, y=-1.296, z=-0.638), carla.Rotation(yaw=55)), 
        #                      imu, {'range': '80', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)
        # radar_r_front_sr = SensorManager(world, display_manager, 'Radar', carla.Transform(carla.Location(x=1.23, y=-1.296, z=-0.638), carla.Rotation(yaw=-55)), 
        #                      imu, {'range': '80', 'vertical_fov': '23', 'horizontal_fov': '110'}, display_pos=None)
        ...
        # Get calibration
        utils.get_camera_calibration(s_fc, image_w, image_h)
        ...
        while not rospy.is_shutdown():
            ...
            try:
                if SIM_STARTED:
                    ...
                    header.frame_id = 'lidar_frame'  # or whatever LiDAR 1 uses
